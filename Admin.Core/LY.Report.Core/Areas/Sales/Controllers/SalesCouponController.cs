...
using EonUp.Delivery.Core.Service.Sales.Coupon;
using EonUp.Delivery.Core.Service.Sales.Coupon.Input;
...
namespace EonUp.Delivery.Core.Areas.Sales.Controllers
{
    ...
    public class SalesCouponController : BaseAreaController
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IResponseOutput> GetPage(PageInput<SalesCouponGetInput> model)
        {
