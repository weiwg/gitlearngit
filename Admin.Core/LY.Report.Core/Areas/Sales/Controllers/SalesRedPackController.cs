...
using EonUp.Delivery.Core.Service.Sales.RedPack;
using EonUp.Delivery.Core.Service.Sales.RedPack.Input;
...
namespace EonUp.Delivery.Core.Areas.Sales.Controllers
{
    ...
    public class SalesRedPackController : BaseAreaController
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IResponseOutput> GetPage(PageInput<SalesRedPackGetInput> model)
        {
