...
using EonUp.Delivery.Core.Service.Auth.Api;
using EonUp.Delivery.Core.Service.Auth.Api.Input;
...
namespace EonUp.Delivery.Core.Areas.Auth.Controllers
{
    ...
    public class ApiController : BaseAreaController
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IResponseOutput> GetPage(PageInput<ApiGetInput> model)
        {
