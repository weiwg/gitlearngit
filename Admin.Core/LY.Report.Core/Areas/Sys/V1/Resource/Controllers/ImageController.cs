...
namespace LY.Report.Core.Areas.Sys.V1.Resource.Controllers
{
    /// <summary>
    /// 图片管理
    /// </summary>
    public class ImageController : BaseAreaController
    {
        ...
        /// <returns></returns>
        [HttpGet]
        public async Task<IResponseOutput> GetListGetPageList([FromQuery] PageInput<ResImgGalleryGetInput> input)
        {
