...
namespace LY.Report.Core.Common.Extensions
{
    public static class DateTimeExtensions
    {
        ...
        /// <param name="dateTime"></param>
        /// <returns></returns>
        public static DateTime ToDayLastTime(this DateTime? dateTime)
        {
            var date = dateTime ?? DateTime.Now.ToLocalTime();
            return new DateTime(date.Year, date.Month, date.Day,23,59,59).AddMilliseconds(998);
        }
    }
}
