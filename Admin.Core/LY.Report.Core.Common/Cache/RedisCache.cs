...
namespace LY.Report.Core.Common.Cache
{
    ...
    public class RedisCache : ICache
    {
        ...
        {
            return RedisHelper.Set(key, value, TimeSpan.FromSeconds(expire));
        }
        ...
        public Task<bool> SetAsync(string key, object value, int expire)
        {
            return RedisHelper.SetAsync(key, value, TimeSpan.FromSeconds(expire));
        }
